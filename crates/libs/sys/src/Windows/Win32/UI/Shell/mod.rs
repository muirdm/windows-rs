...
#[doc = "*Required features: 'Win32_UI_Shell'*"]
pub const STR_PARSE_ALLOW_INTERNET_SHELL_FOLDERS: &'static str = "Allow binding to Internet shell folder handlers and negate STR_PARSE_PREFER_WEB_BROWSING";
#[doc = "*Required features: 'Win32_UI_Shell'*"]
...
#[doc = "*Required features: 'Win32_UI_Shell'*"]
pub const STR_PARSE_PREFER_WEB_BROWSING: &'static str = "Do not bind to Internet shell folder handlers";
#[doc = "*Required features: 'Win32_UI_Shell'*"]
pub const STR_PARSE_PROPERTYSTORE: &'static str = "DelegateNamedProperties";
#[doc = "*Required features: 'Win32_UI_Shell'*"]
pub const STR_PARSE_SHELL_PROTOCOL_TO_FILE_OBJECTS: &'static str = "Parse Shell Protocol To File Objects";
#[doc = "*Required features: 'Win32_UI_Shell'*"]
